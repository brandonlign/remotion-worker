...
source = source.replace('f"- 2025 months scanned:', f'f"- {year} months scanned:')
source = source.replace('f"- Uncatalogued 2025 structures', f'f"- Uncatalogued {year} structures')
source = source.replace('f"- 2025 month/members:', f'f"- {year} month/members:')
source = source.replace('repeat in both 2024 and 2023', f'repeat in both {year - 1} and {year - 2}')
'''

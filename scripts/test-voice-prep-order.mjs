...
const reusePath = script.indexOf("# Recovery should never regenerate");
...
assert.ok(sourceGate < reusePath, "source validation must precede optional Drive voice reuse");

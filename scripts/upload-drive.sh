...
# The stored legacy configuration points at a folder removed during the Drive
# consolidation. Clear that stale pointer only in this ephemeral copy and upload
# one isolated private job folder. The folder is moved into Telic Production
# after connector verification, then this public branch is closed unmerged.
